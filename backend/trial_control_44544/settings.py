"""
Django settings for trial_control_44544 project.
...
ROOT_URLCONF = 'trial_control_44544.urls'
...
WSGI_APPLICATION = 'trial_control_44544.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "trial_control_44544 API",
    "DESCRIPTION": "API documentation for trial_control_44544 App",
    "VERSION": "v1",
}
